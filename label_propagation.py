...
def labelPropagation(Mat_Label, Mat_Unlabel, labels, kernel_type = 'rbf', rbf_sigma = 1.5, 
    ...
    for i in np.arange(num_label_samples):  
    ...
    for i in np.arange(num_unlabel_samples):  
...
if __name__ == "__main__":  
    ...
    #                                       kernel_type = 'knn', knn_num_neighbors = 10, max_iter = 100)  
